...
import { F as Check, H as Bell, N as ChevronRight, O as Circle, h as PanelLeft, p as Search, t as X } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/portal-shell-Bqe4KT1I.js
...
function PortalShell({ sidebar, children, userName, userInitials, userRole }) {
	const navigate = useNavigate();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarProvider, { children: [sidebar, /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarInset, {
		className: "bg-background",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			className: "sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-border/70 bg-background/80 px-4 backdrop-blur-md sm:px-6",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarTrigger, { className: "text-muted-foreground" }),
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								className: "flex items-center gap-2 rounded-full p-1 pr-2 text-left transition hover:bg-muted",
...
function PageHeader({ title, description, actions }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mb-8 grid grid-cols-[minmax(0,1fr)_auto] items-start gap-4",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "min-w-0",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				className: "truncate text-2xl font-semibold tracking-tight sm:text-[28px]",
				children: title
...
//#endregion
export { PageHeader as a, SidebarContent as c, SidebarGroupContent as d, SidebarGroupLabel as f, SidebarMenuItem as g, SidebarMenuButton as h, DropdownMenuTrigger as i, SidebarFooter as l, SidebarMenu as m, DropdownMenuContent as n, PortalShell as o, SidebarHeader as p, DropdownMenuItem as r, Sidebar as s, DropdownMenu as t, SidebarGroup as u };
