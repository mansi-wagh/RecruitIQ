  ...
  head: () => ({
    meta: [
      ...
      { title: "RecruitIQ — AI-powered recruitment platform" },
      {
        name: "description",
        content:
          "RecruitIQ is an AI-powered applicant tracking system for modern hiring teams. Screen candidates, manage jobs, and hire faster.",
      },
      { property: "og:title", content: "RecruitIQ — AI-powered recruitment platform" },
      {
